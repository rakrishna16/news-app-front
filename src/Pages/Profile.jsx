...
<div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-4xl w-full p-8 transition-all duration-300 animate-fade-in">
  ...
  <div className="flex flex-col md:flex-row">
    <div className="md:w-1/3 text-center mb-8 md:mb-0">
      ...
      <h2 className="rounded-full p-5 mx-11 capitalize mb-3 text-lg font-extrabold text-center w-32 h-32 border-4 border-indigo-800 dark:border-blue-900 transition-transform duration-300 hover:scale-105" >{profiled.name ? profiled.name.charAt(0) : ''}</h2>
      <h1 className="text-2xl font-bold text-indigo-800 dark:text-white mb-2">{profiled.name}</h1>
    ...
    <div className="md:w-2/3 md:pl-8">
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {profiled.categories.map((ele, index) => {
          return (
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {profiled.frequency.map((fele, findex) => {
          return (
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {profiled.notificationchannels.map((nele, nindex) => {
          return (

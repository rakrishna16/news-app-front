                      ...
                      <>
                        {shide == "true" ?
                          <>
                            ...
                            <h2 onMouseOver={openProf} className="rounded-full p-1 mx-5 capitalize my-3 text-lg font-extrabold text-center w-10 h-10 bg-white border-4 border-indigo-800 dark:border-blue-900 transition-transform duration-300 hover:scale-105" >{profileu ? profileu[0].name.charAt(0) : ''}</h2>
                          </>
                          :
                          <>
                            ...
                            <h2 onMouseOver={closeProf} className="rounded-full p-1 mx-5 capitalize my-3 text-lg font-extrabold text-center w-10 h-10 bg-white border-4 border-indigo-800 dark:border-blue-900 transition-transform duration-300 hover:scale-105" >{profileu ? profileu[0].name.charAt(0) : ''}</h2>
                          </>
                        }
                      </>
                    )
